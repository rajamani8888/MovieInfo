...
public class MovieDetailRecommendationsAdapter extends RecyclerView.Adapter<MovieDetailRecommendationsAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            mClickListener.onRecommendationsItemClick(r);
        }
    }
}
