...
public class FavouritesMovieAdapter extends RecyclerView.Adapter<FavouritesMovieAdapter.ViewHolder> {
    ...
    public FavouritesMovieAdapter(Context context, FavouritesItemClickListener clickListener) {
